  ...
  const fetchJoke = async () => {
    ...
    return (
      <div className='home-page'>
        ...
        <h3 className="marquee" style={{ color: 'orange' }}>
        🪷😄🎋😎🙌😁✌️🤩😤🗣️🏃‍♀️🧘‍♀️🤞🎼🌺🌷🍂 🪷😄🎋😎🙌😁✌️🤩😤🗣️🏃‍♀️🧘‍♀️🤞🎼🌺🌷🍂
        <div className=""></div>
        </h3>
      </div>
        ...
        <p>
          ...
          wellness has many
            such resources to make you smile even when you feel you can't. We also offer a variety of other resources to help you 
